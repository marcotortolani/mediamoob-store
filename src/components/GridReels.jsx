...
export default function GridReels({ gridElements }) {
  ...
  return (
    <section className=' z-30 relative top-0 w-screen max-w-[750px] h-fit mt-2 mb-16 p-4 bg-moobSky bg-opacity-70  flex items-center justify-center'>
      <div className='w-full h-fit overflow-x-hidden flex flex-col items-start justify-center gap-2  '>
        ...
        <div className='w-full h-fit flex items-center justify-center  content-normal'>
          <ul className=' w-full h-fit p-0  grid place-items-center  grid-cols-3 md:grid-cols-4  gap-3 sm:gap-4 md:gap-5'>
            {gridElements.map((el, i) => (
              ...
              >
                <a
                  ...
                  target='_blank'
                >
                  <div className='relative w-full h-full flex justify-center overflow-hidden rounded-xl'>
                    <img
