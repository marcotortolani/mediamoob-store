          ...
          {reelsElements.map((el, i) => (
            ...
            >
              <a
                ...
                target='_blank'
              >
                <div className='relative w-full h-full flex justify-center overflow-hidden group-hover:shadow-lg group-hover:shadow-gray-600 transition-all ease-in-out duration-300 '>
                  <img
